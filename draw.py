...
def draw_polygons( points, screen, color ):
    ...
    while point < len(points) - 2: 
        a1 = points[point+1][0] - points[point][0]
        a2 = points[point+1][1] - points[point][1]
        b1 = points[point+2][0] - points[point][0]
        b2 = points[point+2][1] - points[point][1]
        n = a1*b2 - a2*b1
        if n > 0:
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            add_polygon(edges, 
                    ...
                    points[nextind][0], points[nextind][1], points[nextind][2],
